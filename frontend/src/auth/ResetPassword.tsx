      ...
      <>
        ...
        >
          ...
          >
            ...
            >
              {getIntl('fr').formatMessage({ id: 'auth.resetPassword.expiredLink' })}
            </Typography>
            <Box sx={{ textAlign: 'center' }}>
              <Link href='/forgot-password' variant='body2'>
                {getIntl('fr').formatMessage({ id: 'auth.resetPassword.requestNewLink' })}
              </Link>
            </Box>
          </Paper>
        </Box>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {getIntl('fr').formatMessage({ id: 'auth.resetPassword.title' })}
            </Typography>
            <Box
              component='form'
            ...
            >
              <Controller
                ...
                render={({ field }) => (
                  <PasswordField
                    {...field}
                    label={getIntl('fr').formatMessage({ id: 'auth.resetPassword.newPassword' })}
              ...
              <Controller
                ...
                render={({ field }) => (
                  <PasswordField
                    {...field}
                    label={getIntl('fr').formatMessage({
              ...
              >
                {getIntl('fr').formatMessage({ id: 'auth.resetPassword.submit' })}
              </Button>
            </Box>
          </Paper>
        </Box>
